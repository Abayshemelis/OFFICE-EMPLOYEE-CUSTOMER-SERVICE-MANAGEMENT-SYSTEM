    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ServiceStartTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    ServiceEndTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    ResolutionNote = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CustomerRating = table.Column<byte>(type: "tinyint unsigned", nullable: true),
                    CustomerFeedback = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceRequests_Users_AssistantId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssistantConductScores", x => x.ScoreId);
                    table.ForeignKey(
                        name: "FK_AssistantConductScores_ServiceRequests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "ServiceRequests",
                        principalColumn: "RequestId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssistantConductScores_Users_AssistantId",
                        column: x => x.AssistantId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "ContactManagerRequests",
                columns: table => new
                {
                    ContactRequestId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    RequestId = table.Column<int>(type: "int", nullable: false),
                    CustomerMessage = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AssistantNote = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ForwardedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    ManagerReply = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactManagerRequests", x => x.ContactRequestId);
                    table.ForeignKey(
                        name: "FK_ContactManagerRequests_ServiceRequests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "ServiceRequests",
                        principalColumn: "RequestId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskAuditLogs", x => x.LogId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssistantConductScores_AssistantId",
                table: "AssistantConductScores",
                column: "AssistantId");

            migrationBuilder.CreateIndex(
                name: "IX_AssistantConductScores_RequestId",
                table: "AssistantConductScores",
                column: "RequestId");

            migrationBuilder.CreateIndex(
                name: "IX_ContactManagerRequests_RequestId",
                table: "ContactManagerRequests",
                column: "RequestId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceRequests_AssistantId",
